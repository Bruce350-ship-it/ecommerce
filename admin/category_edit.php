                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form role="form" action="process_category_edit.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cat" value="<?php echo htmlspecialchars($row['cat_nm'], ENT_QUOTES, 'UTF-8'); ?>" class="form-control">
                                        </div>
                                        ...
                                        <input type="hidden" name="id" value="<?php echo (int)$row['cat_id']; ?>" /> 
